  ...
  benefits: {
    ...
    items: {
      ...
      convenientSizes: {
        ...
        text: 'От 15 до 60 м² — выберите подходящий объём',
      },
      flexibleTerms: {
  ...
  faq: {
    ...
    items: {
      rentalCost: {
        ...
        answer:
          'Стоимость зависит от размера контейнера. Аренда 6-метрового контейнера (15 м²) — от 900 000 сум/мес, 12-метрового (30 м²) — от 1 400 000 сум/мес. Также доступны 45 и 60 м².',
      },
      siteGuarded: {
